...
export default function Navbar() {
  ...
  const handleLogout = ()=>{
    ...
    ctx.setdetails({login:false,token:""})
    navigate('/login')
  ...
  const renderMenu = (
    ...
    >
      <MenuItem onClick={handleMenuClose}><Link style={{textDecoration:"none",color:"black"}} to='/user/profile'>Profile</Link></MenuItem>
      <MenuItem onClick={handleMenuClose}>My account</MenuItem>
     {login===false && <MenuItem ><Link style={{textDecoration:"none",color:"black"}} to={'/login'}>Login</Link></MenuItem>}
    {login===false &&  <MenuItem ><Link style={{textDecoration:"none",color:"black"}} to={'/signup'}>Signup</Link></MenuItem>}
    ...
    <Box sx={{ flexGrow: 1 }}>
      <AppBar position="static" color='primary' sx={{ bgcolor: "green" }}>
        <Toolbar>
          ...
          >
            <Link style={{textDecoration:"none",color:"white"}} to={'/'}>  BlogsApp</Link>
          </Typography>
          <Search>
            <SearchIconWrapper>
              <SearchIcon />
